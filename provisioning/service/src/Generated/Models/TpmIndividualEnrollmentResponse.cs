...
namespace Microsoft.Azure.Devices.Provisioning.Service.Models
{
    ...
    /// </summary>
    public partial class TpmIndividualEnrollmentResponse : IndividualEnrollmentResponse
    {
        /// <summary>
        /// Initializes a new instance of the TpmIndividualEnrollmentResponse
        /// class.
        /// </summary>
        public TpmIndividualEnrollmentResponse()
        {
            CustomInit();
        }
        ...
        /// <param name="attestation">TPM attestation method.</param>
        ...
        public TpmAttestation Attestation { get; set; }
