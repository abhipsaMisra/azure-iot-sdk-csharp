...
namespace Microsoft.Azure.Devices.Provisioning.Service.Models
{
    ...
    /// </summary>
    public partial class EnrollmentGroupOperation
    {
        /// <summary>
        /// Initializes a new instance of the EnrollmentGroupOperation class.
        /// </summary>
        public EnrollmentGroupOperation()
        {
            CustomInit();
        }
        ...
        public EnrollmentGroupOperation(IList<EnrollmentGroupRequest> enrollments, string mode)
        {
        ...
        public IList<EnrollmentGroupRequest> Enrollments { get; set; }
