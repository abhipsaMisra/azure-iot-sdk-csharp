...
namespace Microsoft.Azure.Devices.Provisioning.Service.Models
{
    ...
    /// </summary>
    public partial class EnrollmentGroupRequest
    {
        /// <summary>
        /// Initializes a new instance of the EnrollmentGroupRequest class.
        /// </summary>
        public EnrollmentGroupRequest()
        {
            CustomInit();
        }
        ...
        /// definition.</param>
        public EnrollmentGroupRequest(string enrollmentGroupId, string iotHubHostName = default(string), InitialTwin initialTwin = default(InitialTwin), string etag = default(string), string provisioningStatus = default(string), ReprovisionPolicy reprovisionPolicy = default(ReprovisionPolicy), string allocationPolicy = default(string), IList<string> iotHubs = default(IList<string>), CustomAllocationDefinition customAllocationDefinition = default(CustomAllocationDefinition))
        {
