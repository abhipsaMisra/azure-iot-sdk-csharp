...
namespace Microsoft.Azure.Devices.Provisioning.Service.Models
{
    ...
    /// </summary>
    public partial class X509CAReferencesEnrollmentGroupRequest : EnrollmentGroupRequest
    {
        /// <summary>
        /// Initializes a new instance of the
        /// X509CAReferencesEnrollmentGroupRequest class.
        /// </summary>
        public X509CAReferencesEnrollmentGroupRequest()
        {
            CustomInit();
        }
        ...
        /// <param name="attestation">X509 CA References attestation
        /// method.</param>
        ...
        /// definition.</param>
        public X509CAReferencesEnrollmentGroupRequest(string enrollmentGroupId, X509CAReferences attestation, string iotHubHostName = default(string), InitialTwin initialTwin = default(InitialTwin), string etag = default(string), string provisioningStatus = default(string), ReprovisionPolicy reprovisionPolicy = default(ReprovisionPolicy), string allocationPolicy = default(string), IList<string> iotHubs = default(IList<string>), CustomAllocationDefinition customAllocationDefinition = default(CustomAllocationDefinition))
        ...
        /// <summary>
        /// Gets or sets X509 CA References attestation method.
        /// </summary>
        [JsonProperty(PropertyName = "attestation")]
        public X509CAReferences Attestation { get; set; }
