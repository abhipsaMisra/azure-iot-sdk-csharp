...
namespace Microsoft.Azure.Devices.Provisioning.Service.Models
{
    ...
    /// </summary>
    public partial class X509CertificateEnrollmentGroupRequest : EnrollmentGroupRequest
    {
        /// <summary>
        /// Initializes a new instance of the
        /// X509CertificateEnrollmentGroupRequest class.
        /// </summary>
        public X509CertificateEnrollmentGroupRequest()
        {
            CustomInit();
        }
        ...
        /// definition.</param>
        public X509CertificateEnrollmentGroupRequest(string enrollmentGroupId, X509CertificatesRequest attestation, string iotHubHostName = default(string), InitialTwin initialTwin = default(InitialTwin), string etag = default(string), string provisioningStatus = default(string), ReprovisionPolicy reprovisionPolicy = default(ReprovisionPolicy), string allocationPolicy = default(string), IList<string> iotHubs = default(IList<string>), CustomAllocationDefinition customAllocationDefinition = default(CustomAllocationDefinition))
        ...
        public X509CertificatesRequest Attestation { get; set; }
